...
```
cd existing_repo
git remote add origin https://eim-laboratoriovirtual.unavarra.es/gitlab/gpii-23-24/g15.git
git branch -M main
...
- [ ] [Set up project integrations](https://eim-laboratoriovirtual.unavarra.es/gitlab/gpii-23-24/g15/-/settings/integrations)
